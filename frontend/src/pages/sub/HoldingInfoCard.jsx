...
export default function HoldingInfoCard({
    ...
    return (
        <div
            className="card p-5 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
            {/* 头部：名称、代码、按钮、总收益 */}
            <div
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
                ...
                <div className="space-y-1">
                    <div
                        className="flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 tracking-wider">
