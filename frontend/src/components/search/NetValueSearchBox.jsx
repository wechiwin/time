// src/components/search/NetValueSearchBox.jsx
import { useState, useEffect } from 'react';
import { MagnifyingGlassIcon } from '@heroicons/react/24/outline';

export default function NetValueSearchBox({ onSearch }) {
    const [kw, setKw] = useState('');
    useEffect(() => { const t = setTimeout(() => onSearch(kw), 300); return () => clearTimeout(t); }, [kw, onSearch]);
    return (
